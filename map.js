...
// US territories to exclude from states
const excludedStates = ["Puerto Rico", "Guam", "American Samoa", "US Virgin Islands", "Northern Mariana Islands"];
...
Promise.all([
  ...
  locations.features.forEach(f => {
    ...
    states.features.forEach(state => {
      if(!excludedStates.includes(state.properties.NAME) && turf.booleanPointInPolygon(point, state)) {
